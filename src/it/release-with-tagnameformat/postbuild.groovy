...
if (!buildLog.contains('[INFO] Building release-with-tagnameformat 0.1.0')) {
  throw new IllegalStateException('Project was not transformed correctly.')
}
if (!new java.io.File(basedir, 'pom.xml').readLines('UTF-8').contains('    <connection>scm:svn:https://localhost/svn/MYREPO/tags/tag-release-with-tagnameformat-0.1.0</connection>')) {
